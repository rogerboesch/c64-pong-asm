...
CHARMEM      = $0400            // character memory $0400-$07F0

// Upper RAM Area ($C000-$CFFF | 49152-53247)
MEM_UPRAM    = $C000            // upper RAM area begin

// VIC-II: Video Display ($D000-$DFFF | 53248-54271)
SPRITE0_PTR = $07F8             // sprite pointer #0
SPRITE1_PTR = $07F9             // sprite pointer #1
SPRITE2_PTR = $07FA             // sprite pointer #2
SPRITE3_PTR = $07FB             // sprite pointer #3
...
SCREEN_CTL  = $D011             // screen control register
SPRITE_DBLH = $D017             // sprite double height register
SPRITE_DBLV = $D01D             // sprite double vertical register
BORDER_COL  = $D020             // border color
BGND_COL    = $D021             // background color
SPRITE0_CLR = $D027             // sprite #0 color 
SPRITE1_CLR = $D028             // sprite #1 color 
SPRITE2_CLR = $D029             // sprite #2 color 
SPRITE3_CLR = $D02A             // sprite #3 color
SPRITE_CORD = $D010             // sprite #0-#7 x-coordinates offset (set bit per sprite)
SPRITE_ENBL = $D015             // sprite enable register
SPRITE_COLL = $D01E             // Sprite/sprite collision register

// SID: Audio ($D400-$D7FF | 54272-55295)
SIDV1_FRQL  = $D400             // voice #1 frequency (low-byte)
SIDV1_FRQH  = $D401             // voice #1 frequency (high-byte)
SIDV1_CTRL  = $D404             // voice #1 control register
SIDV1_ATDE  = $D405             // voice #1 Attack and Decay length
SIDV1_SURE  = $D406             // voice #1 Sustain volume and Release length
SID_VOLFLT  = $D418             // volume and filter modes

// CIA: Inputs ($DC00-$DCFF |56320-56575)
CIA_PORTA   = $DC00             // port a, keyboard matrix columns and joystick #2
CIA_PORTB   = $DC01             // port b, keyboard matrix rows and joystick #1

//
// - KERNAL Functions (Constants) =============================================
//

GET_CHAR    = $FFE4             // get character  
...
CHARMEM_X1  = $0500             // offset 1 to charmem
CHARMEM_X2  = $0600             // offset 2 to charmen
CHARMEM_X3  = $06F0             // offset 3 to charmem
